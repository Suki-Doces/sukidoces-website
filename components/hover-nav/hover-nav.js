document.addEventListener('DOMContentLoaded', () => {
    ...
    const toggleButtons = document.querySelectorAll('.hnv-toggle-btn');
    
    // Função para fechar todos os menus
    const closeAllMenus = () => {
        document.querySelectorAll('.hnv-dropdown').forEach(menu => {
            menu.classList.remove('is-open');
        });
        document.querySelectorAll('.hnv-toggle-btn').forEach(btn => {
